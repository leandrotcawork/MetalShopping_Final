...
var (
	...
	ErrProductIDRequired              = errors.New("catalog product id is required")
	ErrSKURequired                    = errors.New("catalog sku is required")
	ErrProductNameRequired            = errors.New("catalog product name is required")
	ErrProductDescriptionTooLong      = errors.New("catalog product description exceeds the governed maximum length")
	ErrProductIdentifierTypeRequired  = errors.New("catalog product identifier type is required")
	ErrProductIdentifierValueRequired = errors.New("catalog product identifier value is required")
