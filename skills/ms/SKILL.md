---
name: ms
description: MetalShopping master orchestrator. Use for any implementation task. Enters plan mode automatically, validates architecture and folder structure before any code, orchestrates specialist skills in the correct order, enforces big-tech engineering standards. Usage: "use $ms to implement X".
---
