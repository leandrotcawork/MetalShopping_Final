...
export const schemaIds = {
  "analytics_block_error_v1.schema": "https://schemas.metalshopping.local/api/analytics_block_error_v1.schema.json",
  "analytics_home_block_v1.schema": "https://schemas.metalshopping.local/api/analytics_home_block_v1.schema.json",
  "analytics_home_v1.schema": "https://schemas.metalshopping.local/api/analytics_home_v1.schema.json",
...
export type AnalyticsBlockErrorV1 = {
  code: string;
  message: string;
  details: Record<string, unknown>;
};

export type AnalyticsHomeBlockV1 = {
  status: "OK" | "NOT_READY" | "ERROR";
  data: Record<string, unknown> | null;
  error: unknown;
};

export type AnalyticsHomeV1 = {
